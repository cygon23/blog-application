<x-app-layout title="Blog Show">
            <article class="col-span-4 md:col-span-3 mt-10 mx-auto py-5 w-full" style="max-width:700px">
                <img class="w-full my-2 rounded-lg" src="{{ $post->getThumbnailImage() }}" alt="thumbanail">
              ...
              <livewire:post-commnets :key="'comments'.$post->id" :$post/>
